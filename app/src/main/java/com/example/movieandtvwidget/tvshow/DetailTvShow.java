...
import static com.example.movieandtvwidget.db.DatabaseContract.TvFavoriteColumns.DESCRIPTION;
import static com.example.movieandtvwidget.db.DatabaseContract.TvFavoriteColumns.NAME;
import static com.example.movieandtvwidget.db.DatabaseContract.TvFavoriteColumns.PHOTO;
import static com.example.movieandtvwidget.db.DatabaseContract.TvFavoriteColumns.POPULAR;
...
public class DetailTvShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoriteHelper = FavoriteHelperTv.getInstance(getApplicationContext());
        favoriteHelper.open();
        ...
        if (favoriteItem != null) {
            ...
            final TvShow detail = getIntent().getParcelableExtra("KEY_EXTRA");
            if (detail != null) {
                ...
                fabAdd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (result > 0) {
                            ...
                            Toast.makeText(DetailTvShow.this, getString(R.string.add_success), Toast.LENGTH_LONG).show();
                            finish();
                        } else {
                            Toast.makeText(DetailTvShow.this, getString(R.string.add_failed), Toast.LENGTH_SHORT).show();
                        }
                ...
                .setPositiveButton(getString(R.string.btn_ok), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (result > 0) {
                            ...
                            Toast.makeText(DetailTvShow.this, getString(R.string.del_fav_failed) + " " + getString(R.string.title_tvshow), Toast.LENGTH_LONG).show();
                        }
                    }
                })
